...
function RegisterPage() {
    ...
    return (
        <motion.div
            ...
            className="h-screen w-full flex overflow-hidden bg-white flex-row-reverse"
        ...
        >
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center relative z-10">
                <div className="w-full max-w-sm md:max-w-md mx-6 lg:mx-12 xl:mx-20 [@media(min-resolution:144dpi)]:scale-[0.80] [@media(min-resolution:192dpi)]:scale-[0.70] transition-transform duration-300">
